...
alter table MARK modify column student_id bigint not null, modify column subject_id bigint not null, modify column mark int add constraint ch_mark check (mark >= 1 and mark <= 10);
